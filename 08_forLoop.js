...
console.log("After loop");
    ...
    // WAP to get reverse table for 100 ==> 99   98   97   96   ---- 80
for (let index = 100; index >=80; index=index-1) { // index = 11
    console.log(index); // 0 1  2 ... 10 
}
console.log("After loop");

    // WAP to get table for 17 ==> 17   31   51   68     ---- 170
for (let index = 17; index <=170; index=index+17) { // index = 11
    console.log(index)
}
console.log("After loop");

    // WAP to get reverse table for 190 ==> 190   172   152   133   ---- 19
for (let index = 190; index >=19; index=index-19) { 
    console.log(index); 
}
console.log("After loop");

// WAP to get table for 8 ==> 8   16   24   32  40    ---- 80
for (let index = 8; index <=80; index=index+8) { // index = 8
    console.log(index); 
}
console.log("After loop");
...
// JavaScript = J a v a S c r  i  p  t
var str = "JavaScript"; // 9
for (let index = 9; index > 0; index--) { // 0  1   2
     var char = str.charAt(index); // J  a v
     console.log(char); 
}
console.log(`-------------------`);
